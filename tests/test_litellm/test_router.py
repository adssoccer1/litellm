...
def test_router_retry_skip_stamp_feeds_deployment_ids_to_skip_on_retry(kwargs, failed_deployment_id, expected):
    exception = Exception("upstream refused this request")
